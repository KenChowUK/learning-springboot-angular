package com.kenchow.empolyeeapp;
...
public class EmpolyeeappApplication {

	public static void main(String[] args) {
		SpringApplication.run(EmpolyeeappApplication.class, args);
	}

	//Below is to solve the problem as found "Access to XMLHttpRequest at 'http://localhost:8080/employee/all' from origin 'http://localhost:4200' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource."
